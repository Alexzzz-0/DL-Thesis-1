...
def load_data():
    ...
    #对于每张照片
    for picname in os.listdir(r"C:\AlexZheng\div\pic2000\pic2000"):
    #for picname in os.listdir(r"E:\Other_Programs\DeepLearning\saveImg"):
        picname_split = picname.split('.')[0]

        #找到对应文档
        for txtname in os.listdir(r"C:\AlexZheng\div\txt2000\txt2000"):
            txtname_spilt = txtname.split('.')[0]

            if txtname_spilt == picname_split:
                with open(r'C:\AlexZheng\div\txt2000\txt2000/'+txtname,'r') as txt_context:
        ...
        #获取图片信息
        picnames = 'C:\AlexZheng\div\pic2000\pic2000/' + picname
